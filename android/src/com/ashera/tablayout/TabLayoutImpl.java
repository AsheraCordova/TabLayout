...
public TabLayoutCommandBuilder setTabPaddingTop(String value) {
	...
	attrs.put("value", value);
return this;}
public TabLayoutCommandBuilder setTabRippleColor(String value) {
	Map<String, Object> attrs = initCommand("tabRippleColor");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
...
public void setTabRippleColor(String value) {
	getBuilder().reset().setTabRippleColor(value).execute(true);
}
