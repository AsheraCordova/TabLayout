...
public class TabFolderImpl extends BaseHasWidgets {
	//start - body
	private Object pane;
	public final static String LOCAL_NAME = "TabFolder"; 
	...
	public void loadAttributes(String localName) {
		...
		ConverterFactory.register("TabFolder.font", new Font());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("typeface").withType("TabFolder.font").withUiFlag(UPDATE_UI_REQUEST_LAYOUT));
		ConverterFactory.register("TabFolder.textStyle", new TextStyle());
		WidgetFactory.registerAttribute(localName, new WidgetAttribute.Builder().withName("textStyle").withType("TabFolder.textStyle").withUiFlag(UPDATE_UI_REQUEST_LAYOUT));
	...
	public  TabFolderImpl(String localname) {
		super(GROUP_NAME, localname);
	}
	public  TabFolderImpl(String groupName, String localname) {
		super(groupName, localname);
	}

	@Override
	public IWidget newInstance() {
		return new TabFolderImpl(groupName, localName);
	}
	...
	public class TabFolderExt extends com.google.android.material.tabs.TabLayout implements ILifeCycleDecorator, com.ashera.widget.IMaxDimension{
		private MeasureEvent measureFinished = new MeasureEvent();
		private OnLayoutEvent onLayoutEvent = new OnLayoutEvent();
		private List<IWidget> overlays;
		public IWidget getWidget() {
			return TabFolderImpl.this;
		}
		...
		protected void onLayout(boolean changed, int l, int t, int r, int b) {
			...
			ViewImpl.setDrawableBounds(TabFolderImpl.this, l, t, r, b);
			if (!isOverlay()) {
			ViewImpl.nativeMakeFrame(asNativeWidget(), l, t, r, b);
			}
			replayBufferedEvents();
	        ViewImpl.redrawDrawables(TabFolderImpl.this);
	        overlays = ViewImpl.drawOverlay(TabFolderImpl.this, overlays);
        ...
        public void drawableStateChanged() {
        	...
        	if (!isWidgetDisposed()) {
        		ViewImpl.drawableStateChanged(TabFolderImpl.this);
        	}
        }
    	...
    	public r.android.view.View inflateView(java.lang.String layout) {
    		...
    		IWidget widget = template.loadLazyWidgets(TabFolderImpl.this);
		...
		public void removeFromParent() {
        	TabFolderImpl.this.getParent().remove(TabFolderImpl.this);
		}
        @Override
		...
		public void setMyAttribute(String name, Object value) {
			...
			TabFolderImpl.this.setAttribute(name, value, !(value instanceof String));
		}
        @Override
    	...
    	public void setState0(Object value) {
    		ViewImpl.setState(TabFolderImpl.this, 0, value);
    	}
    	public void setState1(Object value) {
    		ViewImpl.setState(TabFolderImpl.this, 1, value);
    	}
    	public void setState2(Object value) {
    		ViewImpl.setState(TabFolderImpl.this, 2, value);
    	}
    	public void setState3(Object value) {
    		ViewImpl.setState(TabFolderImpl.this, 3, value);
    	}
    	public void setState4(Object value) {
    		ViewImpl.setState(TabFolderImpl.this, 4, value);
    	}
        	public void state0() {
        		ViewImpl.state(TabFolderImpl.this, 0);
        	}
        	public void state1() {
        		ViewImpl.state(TabFolderImpl.this, 1);
        	}
        	public void state2() {
        		ViewImpl.state(TabFolderImpl.this, 2);
        	}
        	public void state3() {
        		ViewImpl.state(TabFolderImpl.this, 3);
        	}
        	public void state4() {
        		ViewImpl.state(TabFolderImpl.this, 4);
        	}
                        
        public void stateYes() {
        	ViewImpl.stateYes(TabFolderImpl.this);
        	
        }
        
        public void stateNo() {
        	ViewImpl.stateNo(TabFolderImpl.this);
        }
...
private void removeTabById(int id) {
	org.eclipse.swt.widgets.TabItem tab = findTabById(id);
	if (tab != null) {
...
private void nativeCreate(Map<String, Object> params) {
	tabLayout = new CustomTabFolderExt();
	tabFolder = new org.eclipse.swt.widgets.TabFolder(ViewImpl.getParent(this), org.eclipse.swt.SWT.TOP);
	pane = tabFolder;
...
private org.eclipse.swt.widgets.TabItem findTabById(int id) {
	for (int i = 0; i < tabFolder.getItemCount(); i++) {
		org.eclipse.swt.widgets.TabItem cTabItem = tabFolder.getItem(i);
...
public static interface ValueSetter {
	void setValueOnBadgeDrawable(org.eclipse.swt.widgets.TabItem tab, Object value);
}
private void setValueOnBadgeDrawable(Object objValue, ValueSetter valueSetter) {
	if (badgeMenuItemIds != null) {
		...
		for (int i = 0; i < badgeMenuItemIds.size(); i++) {
			...
			org.eclipse.swt.widgets.TabItem badge = findTabById(id);
...
private String getFinalText(org.eclipse.swt.widgets.TabItem tab) {
...
public class TabNative extends com.google.android.material.tabs.TabLayout.Tab {
	org.eclipse.swt.widgets.TabItem tab;
	public TabNative(org.eclipse.swt.widgets.TabFolder tabFolder, int index) {
		this.parent = tabLayout;
		if (index >= 0) {
			this.tab = new org.eclipse.swt.widgets.TabItem(tabFolder, org.eclipse.swt.SWT.NONE, index);
		} else {
			this.tab = new org.eclipse.swt.widgets.TabItem(tabFolder, org.eclipse.swt.SWT.NONE);
		}
...
private void addTab(Object tabItemText, Object tabItemIcon, Object tabItemId, Object layout, Object customTabTitleId, Object customTabiconId,  Object where) {
	...
	if (where != null) {
		...
		if (whereStr.startsWith("at:")) {
			...
			org.eclipse.swt.widgets.TabItem mytab = findTabById(tabId);
	...
	((CustomTabFolderExt)tabLayout).insertIndex = index;
	Tab tab = tabLayout.newTab();
	((CustomTabFolderExt)tabLayout).insertIndex = -1;
...
public class CustomTabFolderExt extends TabFolderExt {
	private int insertIndex = -1;
	@Override
	public void removeAllTabs() {
		while (tabFolder.getItemCount() > 0) {
		    org.eclipse.swt.widgets.TabItem item = tabFolder.getItem(0);
		    item.dispose();
		}
	}
	...
	public void removeTabAt(int position) {
		if (tabFolder.getItemCount() > position) {
		    org.eclipse.swt.widgets.TabItem item = tabFolder.getItem(position);
		    item.dispose();
		}
	}
...
private TabFolderCommandBuilder builder;
private TabFolderBean bean;
public Object getPlugin(String plugin) {
	return WidgetFactory.getAttributable(plugin).newInstance(this);
}
public TabFolderBean getBean() {
	if (bean == null) {
		bean = new TabFolderBean();
	}
	return bean;
}
public TabFolderCommandBuilder getBuilder() {
	if (builder == null) {
		builder = new TabFolderCommandBuilder();
	}
	return builder;
}


public  class TabFolderCommandBuilder extends com.ashera.layout.ViewGroupImpl.ViewGroupCommandBuilder <TabFolderCommandBuilder> {
    public TabFolderCommandBuilder() {
	}
	
	public TabFolderCommandBuilder execute(boolean setter) {
		if (setter) {
...
public TabFolderCommandBuilder removeTab(String value) {
...
return this;}
public TabFolderCommandBuilder removeTabAt(int value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder removeAllTabs() {
...
return this;}
public TabFolderCommandBuilder setOnTabSelected(String value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder setOnTabUnselected(String value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder setOnTabReselected(String value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder addTab(String text,
String icon,
String id,
String layout,
...
return this;}
public TabFolderCommandBuilder setTabIconTint(String value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder selectTab(int value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder updateTabTexts(String value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder setupWithViewPager(String value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder setBadgeNumbers(String value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder setBadgeIsVisibles(String value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder setPadSpaceCount(int value) {
	Map<String, Object> attrs = initCommand("padSpaceCount");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder setTypeface(String value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder setTextStyle(String value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder setFontFamily(String value) {
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder tryGetTextSize() {
...
public TabFolderCommandBuilder setTextSize(String value) {
	Map<String, Object> attrs = initCommand("textSize");
	attrs.put("type", "attribute");
	attrs.put("setter", true);
	attrs.put("orderSet", ++orderSet);
	...
	attrs.put("value", value);
return this;}
public TabFolderCommandBuilder setMenuItemIds(String value) {
...
public class TabFolderBean extends com.ashera.layout.ViewGroupImpl.ViewGroupBean{
		public TabFolderBean() {
			super(TabFolderImpl.this);
		}
...
public void setPadSpaceCount(int value) {
	getBuilder().reset().setPadSpaceCount(value).execute(true);
}
...
private TabFolderCommandParamsBuilder paramsBuilder;
private TabFolderParamsBean paramsBean;

public TabFolderParamsBean getParamsBean() {
	if (paramsBean == null) {
		paramsBean = new TabFolderParamsBean();
	}
	return paramsBean;
}
public TabFolderCommandParamsBuilder getParamsBuilder() {
	if (paramsBuilder == null) {
		paramsBuilder = new TabFolderCommandParamsBuilder();
	}
...
public class TabFolderParamsBean extends com.ashera.layout.ViewGroupImpl.ViewGroupParamsBean{
}
...
public class TabFolderCommandParamsBuilder extends com.ashera.layout.ViewGroupImpl.ViewGroupCommandParamsBuilder<TabFolderCommandParamsBuilder>{
}
