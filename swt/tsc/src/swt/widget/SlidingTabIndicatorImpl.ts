...
export abstract class SlidingTabIndicatorImpl<T> extends ViewGroupImpl<T>{
	//start - body
	static initialize() {
...
//start - staticinit
export abstract class SlidingTabIndicatorImpl_LayoutParams<T> extends ViewGroupImpl_LayoutParams<T> {
	@decorate(Type(() => CommandAttr))
...
export class SlidingTabIndicator_LayoutParams extends SlidingTabIndicatorImpl_LayoutParams<SlidingTabIndicator_LayoutParams> implements ILayoutParam {
    getThisPointer(): SlidingTabIndicator_LayoutParams {
        return this;
    }
...
export class SlidingTabIndicator extends SlidingTabIndicatorImpl<SlidingTabIndicator> implements IWidget{
    getThisPointer(): SlidingTabIndicator {
        return this;
    }
...
SlidingTabIndicatorImpl.initialize();
