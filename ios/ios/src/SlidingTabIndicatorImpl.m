...
@interface ASSlidingTabIndicatorImpl () {
 @public
  ...
  ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *builder_;
  ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean *bean_;
  ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *paramsBuilder_;
  ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean *paramsBean_;
}
...
J2OBJC_FIELD_SETTER(ASSlidingTabIndicatorImpl, builder_, ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *)
J2OBJC_FIELD_SETTER(ASSlidingTabIndicatorImpl, bean_, ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean *)
J2OBJC_FIELD_SETTER(ASSlidingTabIndicatorImpl, paramsBuilder_, ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *)
J2OBJC_FIELD_SETTER(ASSlidingTabIndicatorImpl, paramsBean_, ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean *)
...
@interface ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder () {
 @public
  ASSlidingTabIndicatorImpl *this$0_;
}

@end

@interface ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean () {
 @public
  ASSlidingTabIndicatorImpl *this$0_;
}
...
@interface ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean () {
 @public
  ASSlidingTabIndicatorImpl *this$0_;
}
...
- (ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean *)getBean {
  if (bean_ == nil) {
    bean_ = new_ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean_initWithASSlidingTabIndicatorImpl_(self);
  }
  return bean_;
}
...
- (ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *)getBuilder {
  if (builder_ == nil) {
    builder_ = new_ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder_initWithASSlidingTabIndicatorImpl_(self);
  }
  return builder_;
}
...
- (ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean *)getParamsBean {
  if (paramsBean_ == nil) {
    paramsBean_ = new_ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean_initWithASSlidingTabIndicatorImpl_(self);
  }
  return paramsBean_;
}
...
- (ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *)getParamsBuilder {
  if (paramsBuilder_ == nil) {
    paramsBuilder_ = new_ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder_initWithASSlidingTabIndicatorImpl_(self);
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorBean;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
  };
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "builder_", "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "bean_", "LASSlidingTabIndicatorImpl_SlidingTabIndicatorBean;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "paramsBuilder_", "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
    { "paramsBean_", "LASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "loadAttributes", "LNSString;", "LNSString;LNSString;", "create", "LASIFragment;LJavaUtilMap;", "(Lcom/ashera/core/IFragment;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;)V", "remove", "LASIWidget;", "I", "nativeRemoveView", "add", "LASIWidget;I", "createLayoutParams", "LADView;", "getLayoutParams", "setChildAttribute", "LASIWidget;LASWidgetAttribute;LNSString;LNSObject;", "getChildAttribute", "LASIWidget;LASWidgetAttribute;", "setAttribute", "LASWidgetAttribute;LNSString;LNSObject;LASILifeCycleDecorator;", "getAttribute", "LASWidgetAttribute;LASILifeCycleDecorator;", "checkIosVersion", "nativeCreate", "LJavaUtilMap;", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;)V", "setDividerPadding", "LNSObject;", "setShowDividers", "setId", "setVisible", "Z", "getPlugin", &ASSlidingTabIndicatorImpl_LOCAL_NAME, &ASSlidingTabIndicatorImpl_GROUP_NAME, "LASSlidingTabIndicatorImpl_Divider;LASSlidingTabIndicatorImpl_SlidingTabIndicatorExt;LASSlidingTabIndicatorImpl_CanvasImpl;LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;LASSlidingTabIndicatorImpl_SlidingTabIndicatorBean;LASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean;LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder;" };
  static const J2ObjcClassInfo _ASSlidingTabIndicatorImpl = { "SlidingTabIndicatorImpl", "com.ashera.tablayout", ptrTable, methods, fields, 7, 0x1, 36, 9, -1, 36, -1, -1, -1 };
...
@implementation ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder

- (instancetype)initWithASSlidingTabIndicatorImpl:(ASSlidingTabIndicatorImpl *)outer$ {
  ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder_initWithASSlidingTabIndicatorImpl_(self, outer$);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { NULL, NULL, 0x1, -1, 0, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, 1, 2, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LNSObject;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, 3, 2, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LNSObject;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, 4, 5, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LNSObject;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, 6, 7, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LNSObject;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, 8, 7, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LNSObject;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, 9, 2, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LNSObject;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, 10, 11, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LNSObject;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, 12, 7, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LNSObject;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;", 0x1, 13, 7, -1, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  #pragma clang diagnostic ignored "-Wundeclared-selector"
  methods[0].selector = @selector(initWithASSlidingTabIndicatorImpl:);
  ...
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "this$0_", "LASSlidingTabIndicatorImpl;", .constantValue.asLong = 0, 0x1012, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "LASSlidingTabIndicatorImpl;", "execute", "Z", "setBaselineAligned", "setBaselineAlignedChildIndex", "I", "setDivider", "LNSString;", "setGravity", "setMeasureWithLargestChild", "setWeightSum", "F", "setShowDividers", "setDividerPadding", "Lcom/ashera/layout/ViewGroupImpl$ViewGroupCommandBuilder<Lcom/ashera/tablayout/SlidingTabIndicatorImpl$SlidingTabIndicatorCommandBuilder;>;" };
  static const J2ObjcClassInfo _ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder = { "SlidingTabIndicatorCommandBuilder", "com.ashera.tablayout", ptrTable, methods, fields, 7, 0x1, 26, 1, 0, -1, -1, 14, -1 };
  return &_ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder;
}

@end

void ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder_initWithASSlidingTabIndicatorImpl_(ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *self, ASSlidingTabIndicatorImpl *outer$) {
  self->this$0_ = outer$;
  ASViewGroupImpl_ViewGroupCommandBuilder_init(self);
}

ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *new_ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder_initWithASSlidingTabIndicatorImpl_(ASSlidingTabIndicatorImpl *outer$) {
  J2OBJC_NEW_IMPL(ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder, initWithASSlidingTabIndicatorImpl_, outer$)
}

ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *create_ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder_initWithASSlidingTabIndicatorImpl_(ASSlidingTabIndicatorImpl *outer$) {
  J2OBJC_CREATE_IMPL(ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder, initWithASSlidingTabIndicatorImpl_, outer$)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder)

@implementation ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean

- (instancetype)initWithASSlidingTabIndicatorImpl:(ASSlidingTabIndicatorImpl *)outer$ {
  ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean_initWithASSlidingTabIndicatorImpl_(self, outer$);
  return self;
}

- (id)isBaselineAligned {
  return [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) tryGetBaselineAligned])) executeWithBoolean:false])) isBaselineAligned];
}

- (void)setBaselineAlignedWithBoolean:(jboolean)value {
  (void) [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) setBaselineAlignedWithBoolean:value])) executeWithBoolean:true];
}

- (id)getBaselineAlignedChildIndex {
  return [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) tryGetBaselineAlignedChildIndex])) executeWithBoolean:false])) getBaselineAlignedChildIndex];
}

- (void)setBaselineAlignedChildIndexWithInt:(jint)value {
  (void) [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) setBaselineAlignedChildIndexWithInt:value])) executeWithBoolean:true];
}

- (id)getDivider {
  return [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) tryGetDivider])) executeWithBoolean:false])) getDivider];
}

- (void)setDividerWithNSString:(NSString *)value {
  (void) [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) setDividerWithNSString:value])) executeWithBoolean:true];
}
...
- (void)setGravityWithNSString:(NSString *)value {
  (void) [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) setGravityWithNSString:value])) executeWithBoolean:true];
}

- (id)isMeasureWithLargestChild {
  return [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) tryGetMeasureWithLargestChild])) executeWithBoolean:false])) isMeasureWithLargestChild];
}

- (void)setMeasureWithLargestChildWithBoolean:(jboolean)value {
  (void) [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) setMeasureWithLargestChildWithBoolean:value])) executeWithBoolean:true];
}

- (id)getWeightSum {
  return [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) tryGetWeightSum])) executeWithBoolean:false])) getWeightSum];
}

- (void)setWeightSumWithFloat:(jfloat)value {
  (void) [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) setWeightSumWithFloat:value])) executeWithBoolean:true];
}

- (id)getShowDividers {
  return [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) tryGetShowDividers])) executeWithBoolean:false])) getShowDividers];
}

- (void)setShowDividersWithNSString:(NSString *)value {
  (void) [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) setShowDividersWithNSString:value])) executeWithBoolean:true];
}

- (id)getDividerPadding {
  return [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) tryGetDividerPadding])) executeWithBoolean:false])) getDividerPadding];
}

- (void)setDividerPaddingWithNSString:(NSString *)value {
  (void) [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandBuilder *) nil_chk([this$0_ getBuilder])) reset])) setDividerPaddingWithNSString:value])) executeWithBoolean:true];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LASSlidingTabIndicatorImpl;", "setBaselineAligned", "Z", "setBaselineAlignedChildIndex", "I", "setDivider", "LNSString;", "setGravity", "setMeasureWithLargestChild", "setWeightSum", "F", "setShowDividers", "setDividerPadding" };
  static const J2ObjcClassInfo _ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean = { "SlidingTabIndicatorBean", "com.ashera.tablayout", ptrTable, methods, fields, 7, 0x1, 17, 1, 0, -1, -1, -1, -1 };
  return &_ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean;
}

@end

void ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean_initWithASSlidingTabIndicatorImpl_(ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean *self, ASSlidingTabIndicatorImpl *outer$) {
  self->this$0_ = outer$;
  ASViewGroupImpl_ViewGroupBean_initWithASIWidget_(self, outer$);
}

ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean *new_ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean_initWithASSlidingTabIndicatorImpl_(ASSlidingTabIndicatorImpl *outer$) {
  J2OBJC_NEW_IMPL(ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean, initWithASSlidingTabIndicatorImpl_, outer$)
}

ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean *create_ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean_initWithASSlidingTabIndicatorImpl_(ASSlidingTabIndicatorImpl *outer$) {
  J2OBJC_CREATE_IMPL(ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean, initWithASSlidingTabIndicatorImpl_, outer$)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ASSlidingTabIndicatorImpl_SlidingTabIndicatorBean)

@implementation ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean

- (instancetype)initWithASSlidingTabIndicatorImpl:(ASSlidingTabIndicatorImpl *)outer$ {
  ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean_initWithASSlidingTabIndicatorImpl_(self, outer$);
  return self;
}

- (id)getLayoutGravityWithASIWidget:(id<ASIWidget>)w {
  id<JavaUtilMap> layoutParams = new_JavaUtilHashMap_init();
  id<JavaUtilMap> command = [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *) nil_chk([this$0_ getParamsBuilder])) reset])) tryGetLayoutGravity])) getCommand];
  ...
  return [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *) nil_chk([this$0_ getParamsBuilder])) getLayoutGravity];
}

- (void)setLayoutGravityWithASIWidget:(id<ASIWidget>)w
                         withNSString:(NSString *)value {
  id<JavaUtilMap> layoutParams = new_JavaUtilHashMap_init();
  (void) [layoutParams putWithId:@"layoutParams" withId:[((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *) nil_chk([((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *) nil_chk([this$0_ getParamsBuilder])) reset])) setLayoutGravityWithNSString:value])) getCommand]];
...
- (id)getLayoutWeightWithASIWidget:(id<ASIWidget>)w {
  ...
  (void) [layoutParams putWithId:@"layoutParams" withId:command];
  [((id<ASIWidget>) nil_chk(w)) executeCommandWithJavaUtilMap:layoutParams withASIWidget_CommandCallBack:nil withInt:ASIWidget_COMMAND_EXEC_GETTER_METHOD];
  return [((ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *) nil_chk([this$0_ getParamsBuilder])) getLayoutWeight];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LASSlidingTabIndicatorImpl;", "getLayoutGravity", "LASIWidget;", "setLayoutGravity", "LASIWidget;LNSString;", "getLayoutWeight", "setLayoutWeight", "LASIWidget;F" };
  static const J2ObjcClassInfo _ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean = { "SlidingTabIndicatorParamsBean", "com.ashera.tablayout", ptrTable, methods, fields, 7, 0x1, 5, 1, 0, -1, -1, -1, -1 };
  return &_ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean;
}

@end

void ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean_initWithASSlidingTabIndicatorImpl_(ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean *self, ASSlidingTabIndicatorImpl *outer$) {
  self->this$0_ = outer$;
  ASViewGroupImpl_ViewGroupParamsBean_init(self);
}

ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean *new_ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean_initWithASSlidingTabIndicatorImpl_(ASSlidingTabIndicatorImpl *outer$) {
  J2OBJC_NEW_IMPL(ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean, initWithASSlidingTabIndicatorImpl_, outer$)
}

ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean *create_ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean_initWithASSlidingTabIndicatorImpl_(ASSlidingTabIndicatorImpl *outer$) {
  J2OBJC_CREATE_IMPL(ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean, initWithASSlidingTabIndicatorImpl_, outer$)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ASSlidingTabIndicatorImpl_SlidingTabIndicatorParamsBean)

@implementation ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder

- (instancetype)initWithASSlidingTabIndicatorImpl:(ASSlidingTabIndicatorImpl *)outer$ {
  ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder_initWithASSlidingTabIndicatorImpl_(self, outer$);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LNSObject;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder;", 0x1, 1, 2, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LNSObject;", 0x1, -1, -1, -1, -1, -1, -1 },
    { NULL, "LASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder;", 0x1, 3, 4, -1, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  #pragma clang diagnostic ignored "-Wundeclared-selector"
  ...
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "LASSlidingTabIndicatorImpl;", "setLayoutGravity", "LNSString;", "setLayoutWeight", "F", "Lcom/ashera/layout/ViewGroupImpl$ViewGroupCommandParamsBuilder<Lcom/ashera/tablayout/SlidingTabIndicatorImpl$SlidingTabIndicatorCommandParamsBuilder;>;" };
  static const J2ObjcClassInfo _ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder = { "SlidingTabIndicatorCommandParamsBuilder", "com.ashera.tablayout", ptrTable, methods, NULL, 7, 0x1, 7, 0, 0, -1, -1, 5, -1 };
  return &_ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder;
}

@end

void ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder_initWithASSlidingTabIndicatorImpl_(ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *self, ASSlidingTabIndicatorImpl *outer$) {
  ASViewGroupImpl_ViewGroupCommandParamsBuilder_init(self);
}

ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *new_ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder_initWithASSlidingTabIndicatorImpl_(ASSlidingTabIndicatorImpl *outer$) {
  J2OBJC_NEW_IMPL(ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder, initWithASSlidingTabIndicatorImpl_, outer$)
}

ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder *create_ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder_initWithASSlidingTabIndicatorImpl_(ASSlidingTabIndicatorImpl *outer$) {
  J2OBJC_CREATE_IMPL(ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder, initWithASSlidingTabIndicatorImpl_, outer$)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(ASSlidingTabIndicatorImpl_SlidingTabIndicatorCommandParamsBuilder)
