...
export abstract class TabViewImpl<T> extends ViewGroupImpl<T>{
	//start - body
	static initialize() {
...
//start - staticinit
export abstract class TabViewImpl_LayoutParams<T> extends ViewGroupImpl_LayoutParams<T> {
	@decorate(Type(() => CommandAttr))
...
export class TabView_LayoutParams extends TabViewImpl_LayoutParams<TabView_LayoutParams> implements ILayoutParam {
    getThisPointer(): TabView_LayoutParams {
        return this;
    }
...
export class TabView extends TabViewImpl<TabView> implements IWidget{
    getThisPointer(): TabView {
        return this;
    }
